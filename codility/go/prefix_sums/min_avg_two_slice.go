...
(P, Q) is the sum of A[P] + A[P + 1] + ... + A[Q] divided by the length of the slice. To be precise, the average
...
with the minimal average. If there is more than one slice with a minimal average, you should return
